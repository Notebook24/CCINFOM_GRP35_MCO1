...
public class AdminMenuGroupAddView {
    ...
    public AdminMenuGroupAddView() {
        initializeUI();
    }

    private void initializeUI() {
        frame = new JFrame("Add Menu Category");
        ...
        // Title
        JLabel titleLabel = new JLabel("Add New Menu Category");
    ...
    public void clearFields() {
        nameField.setText("");
        timeStartField.setText("00:00:00");
        timeEndField.setText("23:59:59");
        availableCheckBox.setSelected(true);
    }

    public void showSuccessMessage() {
        JOptionPane.showMessageDialog(frame, "Menu category successfully added!", "Success", JOptionPane.INFORMATION_MESSAGE);
    }
